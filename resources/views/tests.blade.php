                    ...
                    <div class="container-fluid">
                        ...
                        <div id="sidebar-menu">
                                <ul>
                                    ...
                                    <li class="has_sub">
                                        <a href="javascript:void(0);" class="waves-effect "> <h5><span> Assigned Test </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></h5></a>
                                ...
                                <ul>
                                    ...
                                    <li class="has_sub">
                                        <a href="javascript:void(0);" class="waves-effect "> <h5><span> Completed Test </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></h5></a>
                                        <ul class="list-unstyled">
