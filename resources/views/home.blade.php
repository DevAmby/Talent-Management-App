                    ...
                    <div class="row">
                        <div class="col-xl-10">
                            <div class="row">
                                ...
                                <div class="col-lg-4" >
                                    <a href="{{ url('/profiles') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ url('/preferences') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row">
                                                <div class="col-3 align-self-center">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ url('/credentials') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row">
                                                <div class="col-3 align-self-center">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ url('/experiences') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row">
                                                <div class="col-3 align-self-center">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ url('/skills') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row">
                                                <div class="col-3 align-self-center">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ url('/tests') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row">
                                                <div class="col-3 align-self-center">
                                ...
                                <div class="col-lg-4">
                                    <a href="{{ url('/documents') }}" style="color: black;">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row">
                                                <div class="col-3 align-self-center">
