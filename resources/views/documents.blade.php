                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#Library" role="tab">Library</a>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active p-3" id="Assigned" role="tabpanel">
                                                ...
                                                <div class="tab-pane p-3" id="Library" role="tabpanel">
                                                    <p class="font-14 mb-0">
                                                        AMBY
                                                    </p>
                                                </div>
